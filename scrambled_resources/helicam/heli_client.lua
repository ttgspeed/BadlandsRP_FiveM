				...
				if target_vehicle then
					if tracking_spotlight then
						if not pause_Tspotlight then
							...
							TriggerServerEvent('f7e5ccbc-0d1c-48ba-9f32-1c9f0c83d5fa', pause_Tspotlight)
						else
						...
						if Fspotlight_state then
							...
							TriggerServerEvent('03497724-b931-4bdc-b5ed-125ab89f70fc', Fspotlight_state)
						end
						...
						TriggerServerEvent('efeeef65-eae9-4610-8030-f4eb5fdcbb37', target_netID, target_plate, targetposx, targetposy, targetposz)
						PlaySoundFrontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
					end
				else
					if tracking_spotlight then
						...
						TriggerServerEvent('4537caad-1677-4d8e-859e-831cdf33aaa0')
					end
			...
			while helicam and not IsEntityDead(lPed) and (GetVehiclePedIsIn(lPed) == heli) and IsHeliHighEnough(heli) do
				if IsControlJustPressed(0, toggle_helicam) then -- Toggle Helicam
					...
					if manual_spotlight and target_vehicle then -- If exiting helicam while manual spotlight is locked on a target, transition to non-helicam auto tracking spotlight
						TriggerServerEvent('2938c3cc-2af1-4add-bde5-5a43dadd8862')
						local target_netID = VehToNet(target_vehicle)
						local target_plate = GetVehicleNumberPlateText(target_vehicle)
						local targetposx, targetposy, targetposz = table.unpack(GetEntityCoords(target_vehicle))
						pause_Tspotlight = false
				...
				if IsControlJustPressed(0, toggle_spotlight) then -- Spotlight_toggles within helicam
					if tracking_spotlight then -- If tracking spotlight active, pause it & toggle manual spotlight
						...
						if manual_spotlight then
							...
							PlaySoundFrontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
							TriggerServerEvent('c30622c0-c616-4de2-9c57-fea236fb3b85')
						else
							TriggerServerEvent('2938c3cc-2af1-4add-bde5-5a43dadd8862')
						end
				...
				if IsControlJustPressed(0, lightup_key) then
					TriggerServerEvent('c04cad83-7abc-4441-8642-b2a560072a08')
				end

				if IsControlJustPressed(0, lightdown_key) then
					TriggerServerEvent('496d0515-9309-47d1-b4e5-b80cb77309c8')
				end

				if IsControlJustPressed(0, radiusup_key) then
					TriggerServerEvent('e0b4eb67-a918-43b5-ae0a-625c3c3c2a75')
				end

				if IsControlJustPressed(0, radiusdown_key) then
					TriggerServerEvent('608b8c8b-7346-4826-9727-e2d20fadd503')
				end
...
RegisterNetEvent('50d379ac-8178-440f-a86f-daf6e98c5673')
AddEventHandler('50d379ac-8178-440f-a86f-daf6e98c5673', function(serverID, state)
	local heli = GetVehiclePedIsIn(GetPlayerPed(GetPlayerFromServerId(serverID)), false)
	SetVehicleSearchlight(heli, state, false)
end)

RegisterNetEvent('8e005569-c01c-4e7a-91dd-1e7c25344916')
AddEventHandler('8e005569-c01c-4e7a-91dd-1e7c25344916', function(serverID, target_netID, target_plate, targetposx, targetposy, targetposz)
...
RegisterNetEvent('7915c128-d2cc-4d6a-852f-958200a8ffae')
AddEventHandler('7915c128-d2cc-4d6a-852f-958200a8ffae', function(serverID)
	Tspotlight_toggle = false
	tracking_spotlight = false
end)

RegisterNetEvent('b32f6b7c-514b-4d15-865c-bd1e2613c4f6')
AddEventHandler('b32f6b7c-514b-4d15-865c-bd1e2613c4f6', function(serverID, pause_Tspotlight)
...
RegisterNetEvent('d1ee5c74-04ad-4ae1-b928-2135986a9a9b')
AddEventHandler('d1ee5c74-04ad-4ae1-b928-2135986a9a9b', function(serverID)
...
RegisterNetEvent('66cdb535-8e4f-4dd5-9311-b953e16ae7f0')
AddEventHandler('66cdb535-8e4f-4dd5-9311-b953e16ae7f0', function(serverID)
	Mspotlight_toggle = false
end)

RegisterNetEvent('e271d232-d180-4fdb-a83f-9921cabad88c')
AddEventHandler('e271d232-d180-4fdb-a83f-9921cabad88c', function(serverID)
...
RegisterNetEvent('013a8732-22b4-4cf7-9344-8562c7f51dfa')
AddEventHandler('013a8732-22b4-4cf7-9344-8562c7f51dfa', function(serverID)
...
RegisterNetEvent('e157529e-db22-4561-98e9-6a81caf3869f')
AddEventHandler('e157529e-db22-4561-98e9-6a81caf3869f', function(serverID)
...
RegisterNetEvent('d4770c50-be2b-453b-b87e-3a295c0e82bc')
AddEventHandler('d4770c50-be2b-453b-b87e-3a295c0e82bc', function(serverID)
