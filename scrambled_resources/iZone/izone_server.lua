	...
	if resource == "iZone" then
		MySQL.Async.fetchAll("SELECT name,coords,gravityCenter,longestDistance FROM zones",{},function(rows)
			if #rows > 0 then  -- found
				...
				TriggerClientEvent('e12bede2-9d1d-45f7-93a4-c6d472b5b724', -1, allZone)
			end
		end)
	end
end)
...
AddEventHandler('bb28a4b4-e680-4f5e-9c58-9d0ef716da70',function(user_id, source, first_spawn)
	if first_spawn then
		TriggerClientEvent('e12bede2-9d1d-45f7-93a4-c6d472b5b724', source, allZone)
	end
end)

RegisterServerEvent('1bc15660-e5a6-4aba-80af-054ee1750f63')
AddEventHandler('1bc15660-e5a6-4aba-80af-054ee1750f63', function()
	TriggerClientEvent('e12bede2-9d1d-45f7-93a4-c6d472b5b724', source, allZone)
end)
...
if commands_enabled then
	AddEventHandler('chatMessage', function(from,name,message)
	  if(string.sub(message,1,1) == "/") then
	    ...
	    if (cmd == "/start") then
	      	CancelEvent()
	      	TriggerClientEvent('025bc185-470a-4842-b0f5-92c32fe10eea', from, "Tu peux ajouter des points avec la touche [L], /mazone stop pour finir", true)
			TriggerClientEvent('f2f4a044-4bd0-45ec-8610-f918ae544608', from)
			actualUserZone = {}
	    elseif cmd == "/stop" then
	    	CancelEvent()
	    	points = actualUserZone
			if points == nil then
				TriggerClientEvent('025bc185-470a-4842-b0f5-92c32fe10eea', from, "Tu as stoppé l'ajout de point mais tu n'avais pas enregistré de points ou initialisé avec /mazone start", false)
				actualUserZone = {}
			else
				TriggerClientEvent('025bc185-470a-4842-b0f5-92c32fe10eea', from, "Ton/Tes points sont sauvegardé avec le nom que tu vas entrer.", true)
				TriggerClientEvent('931c5d5b-980a-4194-9a42-a97229dad129', from)
			end
		elseif cmd == "/tptc" then
			if #args == 4 then
				TriggerClientEvent('025bc185-470a-4842-b0f5-92c32fe10eea', source, "TP ok", true)
				TriggerClientEvent('74ed97fa-5566-4382-ac04-ea051da6f614', source, tonumber(args[2]), tonumber(args[3]), tonumber(args[4]))
			else
				TriggerClientEvent('025bc185-470a-4842-b0f5-92c32fe10eea', source, "3 arguments necessaires", false)
			end
	    end
	  end
	end)
...
RegisterServerEvent('1a15e6a3-0c29-4385-81ad-60dd72f58bae')
AddEventHandler('1a15e6a3-0c29-4385-81ad-60dd72f58bae', function(xs, ys, zs)
...
RegisterServerEvent('b35da151-d15b-4820-8677-abd087730d33')
AddEventHandler('b35da151-d15b-4820-8677-abd087730d33', function(name)
...
RegisterServerEvent('1b2146d2-2437-4419-82d9-ae30b1d9110f')
AddEventHandler('1b2146d2-2437-4419-82d9-ae30b1d9110f', function()
	TriggerClientEvent('e347cc0b-38e5-4b85-88d4-ac6c2c4f98c3', source, allZone)
end)
