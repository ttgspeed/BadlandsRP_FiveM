...
RegisterNetEvent('993cab93-c298-4ff8-ba8c-96cab3bda3f5')
AddEventHandler('993cab93-c298-4ff8-ba8c-96cab3bda3f5', function()
  Citizen.CreateThread(function()
    local display = true

    TriggerEvent('03fe07fb-8eda-4c40-a17b-62d7bfb24df4', true)
  end)
end)

RegisterNetEvent('03fe07fb-8eda-4c40-a17b-62d7bfb24df4')
AddEventHandler('03fe07fb-8eda-4c40-a17b-62d7bfb24df4', function(value)
	print("enable ui...")
	EnableGui(value)
end)
