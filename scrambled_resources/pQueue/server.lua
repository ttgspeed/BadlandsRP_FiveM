...
Citizen.CreateThread(function()
	...
	AddEventHandler('playerConnecting', function(name, setCallback, deferrals)
		...
		while banned == nil or vacCheckInProgress or ageCheckInProgress do Citizen.Wait(0) end
...
RegisterServerEvent('3f500ff3-80b4-409f-ab44-174db5da4411')
AddEventHandler('3f500ff3-80b4-409f-ab44-174db5da4411', playerActivated)
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		if exports and exports.connectqueue then TriggerEvent('ce282be1-ee85-46a1-b5ba-42a3556afce3') return end
	end
end)
...
AddEventHandler('822b3178-da5c-4256-8ffa-914d2c23d3ca', function(src, setKickReason)
