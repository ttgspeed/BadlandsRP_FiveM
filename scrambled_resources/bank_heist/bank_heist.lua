...
RegisterNetEvent('d31295f7-7b31-4ba2-b116-5258daa80aa8')
AddEventHandler('d31295f7-7b31-4ba2-b116-5258daa80aa8',
	function(status)
...
RegisterNetEvent('39626b4c-686b-4d9a-b8f3-261d532bfc73')
AddEventHandler('39626b4c-686b-4d9a-b8f3-261d532bfc73',
	function()
...
RegisterNetEvent('bf6f6300-8ea3-4b3a-8df9-876e967879a8')
AddEventHandler('bf6f6300-8ea3-4b3a-8df9-876e967879a8',
	function(timer)
		robbingBank = true
		Citizen.CreateThread(
			function()
				...
				if died then
					TriggerServerEvent('d01cffcf-9a85-4228-9b9b-89948ea18978')
					robbingBank = false
				end
			end
		)
...
RegisterNetEvent('c372f95b-020a-473d-af4d-d540b1dcd1f3')
AddEventHandler('c372f95b-020a-473d-af4d-d540b1dcd1f3',
	function()
		Citizen.CreateThread(
			function()
				Citizen.Wait(1)
				...
				while robbingBank and not died and not success do
					...
					if not hasBag and (Vdist(playerPos.x, playerPos.y, playerPos.z, 254.61827087402,225.81831359863,101.87574005127) < 5.0) then
						...
						TriggerServerEvent('4edd5c40-f4d8-49c0-b5d8-df3826d48ff3')
					end
				...
				if success then
					TriggerServerEvent('fa57f4cb-d5ca-45c1-bd83-32e8f38461c9')
			...
			if (Vdist(playerPos.x, playerPos.y, playerPos.z, x, y, z) < 100.0 and not heistInProgress) then
				...
				if (Vdist(playerPos.x, playerPos.y, playerPos.z, x, y, z) < 2.0) then
					...
					if IsControlJustReleased(1, Keys['E']) then
						TriggerServerEvent('c0ca6dd9-4d53-40eb-8696-2abbe01ebdcb')
					end
				end
			end
