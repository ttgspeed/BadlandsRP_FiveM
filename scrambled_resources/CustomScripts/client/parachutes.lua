...
local parachute_locations = {
  ...
  {1744.6905517578,3301.0944824218,41.22346496582},
	{454.5520324707,5571.8120117188,781.18438720704}
}
         ...
         if(Vdist(pos.x, pos.y, pos.z, v[1], v[2], v[3]) < 2.0)then
           ...
           if(IsControlJustReleased(1, Keys["E"])) then
             if not IsPedSittingInAnyVehicle(ped) then
               TriggerEvent('1ce2a1c6-8967-482f-8442-30132c012b8c', {text = "You grab a dusty old parachute from the hangar floor. Surely it's up to regulation." , type = "alert", timeout = 5000})
