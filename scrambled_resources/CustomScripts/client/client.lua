...
RegisterNetEvent('036ac857-3a3c-4ba9-b985-cad99a596de1')
AddEventHandler('036ac857-3a3c-4ba9-b985-cad99a596de1', function(style)
	if style ~= "clear" then
	...
	while true do
		...
		if (IsControlPressed(0, 21) or IsDisabledControlPressed(0, 21)) and (IsControlJustPressed(0, 166) or IsDisabledControlJustPressed(0, 166)) then
			if minimal_hud_active then
				TriggerEvent('0cc89472-975e-4f98-b103-fa7329cf7358',true)
		...
		elseif (IsControlJustPressed(0, 166) or IsDisabledControlJustPressed(0, 166)) then
			...
			if minimal_hud_active then
				...
				TriggerEvent('0cc89472-975e-4f98-b103-fa7329cf7358',false)
