...
local function DriveInGarage()
	...
	--Lock the garage
	TriggerServerEvent('d6e30ed8-4aab-43d3-a795-fe63b96c64da',true,currentgarage)
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
		...
		TriggerServerEvent('de2a7aff-ab77-4806-9cb0-be0131be511e',vehicle_names[model][1],myveh.mods,vcolor1,vcolor2,ecolor1,ecolor2,myveh.wheeltype,myveh.plateindex,myveh.windowtint,smokecolor1,smokecolor2,smokecolor3,neoncolor1,neoncolor2,neoncolor3)
		...
		TriggerServerEvent('3264074e-098e-4738-85e9-68832ed49689', myveh)
		...
		--Unlock the garage
		TriggerServerEvent('d6e30ed8-4aab-43d3-a795-fe63b96c64da',false,currentgarage)
...
function LSCMenu:onButtonSelected(name, button)
	...
	TriggerServerEvent('f6811409-861b-4ee2-b52b-4e3ded922f92', name, button)
end

--So we get the button back from server +  bool that determines if we can prchase specific item or not
RegisterNetEvent('504a0b66-0d05-4b09-bf22-f35c3227aad2')
AddEventHandler('504a0b66-0d05-4b09-bf22-f35c3227aad2', function(name, button, canpurchase)
	name = name:lower()
	local m = LSCMenu.currentmenu
	local price = button.price or 0
	local veh = myveh.vehicle
...
AddEventHandler('playerSpawned', function(spawn)
	if firstspawn == 0 then
		AddBlips()
		TriggerServerEvent('09ff8574-8436-42f2-bf98-e913b6dc2c1f')
		firstspawn = 1
	end
end)

--Locks the garage if someone enters it
RegisterNetEvent('5852317a-87f8-47f3-a0af-7e3db05ad871')
AddEventHandler('5852317a-87f8-47f3-a0af-7e3db05ad871', function(tbl)
