...
AddEventHandler('playerSpawned', function()
  TriggerServerEvent('99860454-d585-4b5c-922a-0c6ebb990fbb')
end)
...
function startttest()
  if test_stage == 0 then
    ...
    TriggerServerEvent('11b8f044-25bd-4e91-890b-75fbc87e7b00')
    openGui()
...
function startptest()
  if test_stage < 2 then
    ...
    TriggerServerEvent('ada0755c-07de-4147-8828-1ff70e78ce31')
    ...
    SpeedControl = 1
    TriggerEvent('a1586f44-4e7e-4aa7-ba56-81e7b554e88f', true)
    DTut()
  end
end
...
function EndDTest()
  if error_points >= maxErrors then
    ...
    EndTestTasks()
    TriggerEvent('a1586f44-4e7e-4aa7-ba56-81e7b554e88f', false)
  elseif test_start_error then
    ...
    TriggerServerEvent('0c1efe74-aa8a-4954-a50f-1cd1067fe2b4')
    SetEntityAsMissionEntity(spawned_car,true,true)
    DeleteVehicle(spawned_car)
    EndTestTasks()
    TriggerEvent('a1586f44-4e7e-4aa7-ba56-81e7b554e88f', false)
...
function SpawnTestCar()
  ...
  if HasModelLoaded(vehicleHash) then
    ...
    in_test_vehicle = 1
    TriggerEvent('1ce2a1c6-8967-482f-8442-30132c012b8c', {
...
RegisterNUICallback('close', function(data, cb)
  ...
  closeGui()
  cb('ok')
  TriggerServerEvent('11d4c114-22d8-41c5-be7c-8045bcae3cd9')
