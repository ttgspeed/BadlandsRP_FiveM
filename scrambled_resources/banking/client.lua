...
RegisterNUICallback('quickCash', function(data, cb)
  TriggerEvent('8fd546b5-9453-4cf6-b74f-20952ef79115', 100)
  cb('ok')
end)

RegisterNUICallback('withdrawSubmit', function(data, cb)
  TriggerEvent('8fd546b5-9453-4cf6-b74f-20952ef79115', data.amount)
  cb('ok')
end)

RegisterNUICallback('depositSubmit', function(data, cb)
  TriggerEvent('0ba5e950-5d25-467f-aac5-39f578a34e70', data.amount)
  cb('ok')
end)

RegisterNUICallback('transferSubmit', function(data, cb)
  local fromPlayer = GetPlayerServerId();
  TriggerEvent('0edf01a7-e48f-408f-a222-f3061c4e76e9', tonumber(fromPlayer), tonumber(data.toPlayer), tonumber(data.amount))
  cb('ok')
end)
...
RegisterNetEvent('0ba5e950-5d25-467f-aac5-39f578a34e70')
AddEventHandler('0ba5e950-5d25-467f-aac5-39f578a34e70', function(amount)
  if(IsNearBank() == true or depositAtATM == true and IsNearATM() == true or depositAnywhere == true ) then
    if (IsInVehicle()) then
      ...
      TriggerServerEvent('069d6dd5-7a37-4996-bf8d-60d3cd5aa863', tonumber(amount))
    end
  else
...
RegisterNetEvent('8fd546b5-9453-4cf6-b74f-20952ef79115')
AddEventHandler('8fd546b5-9453-4cf6-b74f-20952ef79115', function(amount)
  if(IsNearATM() == true or IsNearBank() == true or withdrawAnywhere == true) then
    if (IsInVehicle()) then
      TriggerEvent('chatMessage', "", {255, 0, 0}, "^1You cannot use the bank from inside a vehicle!");
    else
      TriggerServerEvent('7461da52-aaea-423c-923b-09da29880b99', tonumber(amount))
    end
  else
...
RegisterNetEvent('8d42ea71-c73b-4f06-b7e2-8dc4024a7c1a')
AddEventHandler('8d42ea71-c73b-4f06-b7e2-8dc4024a7c1a', function(toPlayer, amount)
...
RegisterNetEvent('0edf01a7-e48f-408f-a222-f3061c4e76e9')
AddEventHandler('0edf01a7-e48f-408f-a222-f3061c4e76e9', function(fromPlayer, toPlayer, amount)
  local player2 = GetPlayerFromServerId(toPlayer)
  local playing = IsPlayerPlaying(player2)
  if (playing ~= false) then
    TriggerServerEvent('69a1f1b4-6d89-45f8-a85c-1a43356841f6', fromPlayer, toPlayer, tonumber(amount))
  else
    TriggerEvent('chatMessage', "", {255, 0, 0}, "^1This player is not online!");
  end
end)
...
RegisterNetEvent('cef14c1a-ee85-4873-9437-5f062c94d38c')
AddEventHandler('cef14c1a-ee85-4873-9437-5f062c94d38c', function(balance)
  local id = PlayerId()
...
RegisterNetEvent('ea4dc3d6-6ee9-4e04-9c52-2fa2d413ae51')
AddEventHandler('ea4dc3d6-6ee9-4e04-9c52-2fa2d413ae51', function(amount)
	SendNUIMessage({
		addBalance = true,
		amount = amount
	})
...
RegisterNetEvent('77e556cc-eb55-455e-afb6-a16cc4ddfeb4')
AddEventHandler('77e556cc-eb55-455e-afb6-a16cc4ddfeb4', function(amount)
	SendNUIMessage({
		removeBalance = true,
		amount = amount
	})
...
RegisterNetEvent('37059c50-9b00-4e5c-b7f7-3d8bd8ee1e76')
AddEventHandler('37059c50-9b00-4e5c-b7f7-3d8bd8ee1e76', function(balance)
  local id = PlayerId()
  local playerName = vrpName or GetPlayerName(id)
  SendNUIMessage({
...
RegisterNetEvent('2f9bfed4-e786-4bf8-94b2-9998f9be3291')
AddEventHandler('2f9bfed4-e786-4bf8-94b2-9998f9be3291', function(amount)
  SendNUIMessage({
    addCashBalance = true,
    amount = amount
  })
...
RegisterNetEvent('9d0b6ecb-9ffe-488e-bb48-dc8562db6e3f')
AddEventHandler('9d0b6ecb-9ffe-488e-bb48-dc8562db6e3f', function(amount)
  SendNUIMessage({
...
RegisterNetEvent('14342b8b-abc8-4437-a13b-3837fc6d41e7')
AddEventHandler('14342b8b-abc8-4437-a13b-3837fc6d41e7', function(nameJob)
  SendNUIMessage({
    updateJob = true,
    job = nameJob
  })
...
RegisterNetEvent('d4b15da8-c8ad-411d-8321-6f14d2d5c67d')
AddEventHandler('d4b15da8-c8ad-411d-8321-6f14d2d5c67d', function(drink)
  SendNUIMessage({
    updateThirst = true,
    thirst = drink,
  })
...
RegisterNetEvent('23ad28d0-b6b3-4528-ad52-77739a3c2632')
AddEventHandler('23ad28d0-b6b3-4528-ad52-77739a3c2632', function(food)
  SendNUIMessage({
    updateHunger = true,
    hunger = food
  })
...
RegisterNetEvent('e7db8035-879c-4a27-a13d-cb703b5a581a')
AddEventHandler('e7db8035-879c-4a27-a13d-cb703b5a581a', function(toggle)
  if toggle ~= nil then
    toggleBankUI(toggle)
  end
end)
