...
Citizen.CreateThread(function()
	for k,v in ipairs(scavenger_sites) do
		if v.blip then
			TriggerEvent('9eddc4d7-bc93-47d0-97f4-f9124b63ff39', 161, v.x, v.y, v.z, v.name)
		end
	end
end)

RegisterNetEvent('9eddc4d7-bc93-47d0-97f4-f9124b63ff39')
AddEventHandler('9eddc4d7-bc93-47d0-97f4-f9124b63ff39', function(type, x, y, z, name)
