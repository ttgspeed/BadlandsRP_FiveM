				...
				if coma_left > 0 and bleedOutTime > 0 then
					...
					if not tvRP.isHandcuffed() then
						...
						if (IsControlJustReleased(1, Keys['Y'])) or (tvRP.getMedicCopCount() < 1) or bleedOutTime < 1 then
							...
							TriggerServerEvent('d2167c33-63b4-4413-b9c8-62a6d2158854') -- Respawn
...
-- Outside of resource
RegisterNetEvent('9bd1659f-0b7b-448b-bc16-069756df4a5c')
AddEventHandler('9bd1659f-0b7b-448b-bc16-069756df4a5c',function (time)
