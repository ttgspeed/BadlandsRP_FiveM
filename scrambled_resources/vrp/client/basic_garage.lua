...
function tvRP.vc_TowTruck()
  TriggerEvent('ba95c5d4-78aa-4286-85ab-b0bd4d644308')
end
...
function tvRP.newLockToggle(vehicle)
  if vehicle ~= nil then
    ...
    if locked then -- unlock
      ...
      tvRP.notify("Vehicle unlocked.")
      TriggerEvent('7fc89954-c170-42e8-8cf3-550d52ae0459', 'unlock', 0.3)
    else -- lock
      if (GetVehicleClass(vehicle) == 14) then
      ...
      tvRP.notify("Vehicle locked.")
      TriggerEvent('7fc89954-c170-42e8-8cf3-550d52ae0459', 'lock', 0.3)
    end
  end
end
...
function checkCar(car,ped)
  if car ~= 0 then
    ...
    elseif carName == "Kart3" then
      TriggerEvent('7ffd7df1-c757-4b01-a951-5c59762d7887', "gokart", function(cb)
...
RegisterNetEvent('a1586f44-4e7e-4aa7-ba56-81e7b554e88f')
AddEventHandler('a1586f44-4e7e-4aa7-ba56-81e7b554e88f', function(flag)
  inDriveTest = flag
end)
...
RegisterNetEvent('f5e6a29d-b3d2-454f-814f-46543f3af9bd')
AddEventHandler('f5e6a29d-b3d2-454f-814f-46543f3af9bd', function(extra,toggle)
...
RegisterNetEvent('8ec71420-4bbc-45b3-8100-81379454f06f')
AddEventHandler('8ec71420-4bbc-45b3-8100-81379454f06f', function(value)
  if value ~= nil then
    if IsPedInAnyVehicle(GetPlayerPed(-1), false) then
      local veh = GetVehiclePedIsIn(GetPlayerPed(-1), false)
      if veh ~= nil and (GetPedInVehicleSeat(veh, -1) == GetPlayerPed(-1)) then
