...
function tvRP.setCop(flag)
  ...
  if cop then
    ...
    vRPserver.addPlayerToActivePolive({})
		TriggerEvent('ce2901b9-5b18-4af7-85d4-abd4ac84249c',true)
    ...
    vRPserver.removePlayerToActivePolive({})
		TriggerEvent('ce2901b9-5b18-4af7-85d4-abd4ac84249c',false)
...
function tvRP.toggleHandcuff()
  ...
  TriggerEvent('c1068f26-5ece-431b-8f3e-17a2432d4c87', handcuffed)
  ...
  if handcuffed then
    ...
    TriggerServerEvent('0ff9286b-c62f-4d95-adc9-3c41dfa844d6', 5.0, 'cuff', 0.1)
  else
    tvRP.stopAnim(false)
    tvRP.stopAnim(true)
...
RegisterNetEvent('a24548e4-3914-400d-aeca-ac42a7baed9f')
AddEventHandler('a24548e4-3914-400d-aeca-ac42a7baed9f', function()
      ...
      if not tvRP.isInWater() then
        if not IsPauseMenuActive() then
          ...
          if IsControlJustReleased( 0, 20 ) then -- INPUT_CHARACTER_WHEEL (LEFT ALT)
            TriggerServerEvent('3fc61ce0-a766-4508-9fa9-5374b05f5323', 'off', 0.05)
            ClearPedTasks(ped)
            SetEnableHandcuffs(ped, false)
          else
            if IsControlJustPressed( 0, 20 ) and not IsPlayerFreeAiming(PlayerId()) then -- INPUT_CHARACTER_WHEEL (LEFT ALT)
              TriggerServerEvent('3fc61ce0-a766-4508-9fa9-5374b05f5323', 'on', 0.05)
