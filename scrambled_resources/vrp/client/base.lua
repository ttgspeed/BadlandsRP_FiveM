...
RegisterNetEvent('b5869bfb-0db6-4a76-9db6-d214b2e525f1')
AddEventHandler('b5869bfb-0db6-4a76-9db6-d214b2e525f1', function(hostname)
	SendNUIMessage({
		meta = 'setHostName',
		name = hostname
	})
...
function tvRP.setJobLabel(groupName)
	TriggerEvent('14342b8b-abc8-4437-a13b-3837fc6d41e7', groupName)
end
...
AddEventHandler('playerSpawned',function()
	TriggerServerEvent('d2167c33-63b4-4413-b9c8-62a6d2158854')
end)
