      ...
      if hasBeenInVehicle then
        for i,k in pairs(vehWeapons) do
          if not alreadyHaveWeapon[i] then
            TriggerEvent('856cf526-c158-4f52-ba2b-8a170abfbe6f',k)
          end
        end
...
RegisterNetEvent('856cf526-c158-4f52-ba2b-8a170abfbe6f')
AddEventHandler('856cf526-c158-4f52-ba2b-8a170abfbe6f', function(wea)
