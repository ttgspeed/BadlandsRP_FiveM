...
function task_save_datatables()
	TriggerEvent('a1584587-16fb-4df4-9736-273381ffa701')
						...
						vRP.isWhitelisted(user_id, function(whitelisted)
							if not config.whitelist or whitelisted then
								...
								if vRP.rusers[user_id] == nil then -- not present on the server, init
									...
									vRP.getUData(user_id, "vRP:datatable", function(sdata)
										...
										if tmpdata ~= nil then
                                            ...
                                            MySQL.Async.execute('UPDATE vrp_users SET last_login = @last_login WHERE id = @user_id', {user_id = user_id, last_login = last_login_stamp}, function(rowsChanged) end)
												...
												TriggerEvent('2ebdc20f-a340-4cc8-816c-5cef2b67dcc7', user_id, source, name, tmpdata.last_login)
											end)
										end
									end)
									...
									TriggerEvent('3cb07c14-e9bf-486f-9bd2-e594a1519f17', user_id, source, name)
...
AddEventHandler('playerDropped',function(reason)
	...
	if user_id ~= nil then
		TriggerEvent('87f55cb6-f8c0-441d-9a07-dc7e493f87e0', user_id, source)
...
RegisterServerEvent('d2167c33-63b4-4413-b9c8-62a6d2158854')
AddEventHandler('d2167c33-63b4-4413-b9c8-62a6d2158854', function()
	...
	if user_id ~= nil then
		...
		if first_spawn then
			...
			TriggerClientEvent('b5869bfb-0db6-4a76-9db6-d214b2e525f1',source,GetConvar('blrp_watermark','badlandsrp.com'))
			--TriggerEvent('8f67e2d8-e5d2-4095-bedd-0e0c4a675208',player)
			TriggerClientEvent('993cab93-c298-4ff8-ba8c-96cab3bda3f5', player)
		end
		...
		TriggerEvent('1defbc3c-6327-496c-951a-8449c1a25754',user_id,player,first_spawn) --prioritize player_state over other initializations

		SetTimeout(2000, function() -- trigger spawn event
			TriggerEvent('bb28a4b4-e680-4f5e-9c58-9d0ef716da70',user_id,player,first_spawn)
...
RegisterServerEvent('f3c7c7c9-3e2a-4b37-8542-286b9a1a2317')
