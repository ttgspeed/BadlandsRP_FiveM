...
RegisterNetEvent('203e7d64-d3df-4a5b-8f75-489e5228fe28')
AddEventHandler('203e7d64-d3df-4a5b-8f75-489e5228fe28',function(model)
    changemodel(model,nil)
    Notify("~r~Model loaded")
end)

RegisterNetEvent('2fe2160a-fb0c-4187-99fa-704da1c6b2d4')
AddEventHandler('2fe2160a-fb0c-4187-99fa-704da1c6b2d4',function(model)
    changempmodel(model,nil)
    Notify("~r~MP Model loaded")
end)

RegisterNetEvent('149aafe7-08fc-4b54-90ea-c7c8f7618558')
AddEventHandler('149aafe7-08fc-4b54-90ea-c7c8f7618558',function(model)
    changemodel(model,nil)
    Notify("~r~Model loaded")
end)

RegisterNetEvent('e6fe8994-3d69-4249-8ca2-8403f75016af')
AddEventHandler('e6fe8994-3d69-4249-8ca2-8403f75016af',function(model)
    changempmodel(model,nil)
    Notify("~r~MP Model loaded")
end)

RegisterNetEvent('053e44b4-7187-4f19-80fb-29fa828bc1a2')
AddEventHandler('053e44b4-7187-4f19-80fb-29fa828bc1a2',function()
    Notify("~g~Change your character at any clothing store!")
end)

RegisterNetEvent('11182af4-0d51-47ee-a423-f1395768176a') --Sets mask and texture when spawned
AddEventHandler('11182af4-0d51-47ee-a423-f1395768176a',function(user)
...
RegisterNetEvent('ee540df8-5db8-40b0-8deb-82cb2a05da5d') --Sets mask and texture when spawned
AddEventHandler('ee540df8-5db8-40b0-8deb-82cb2a05da5d',function(user)
    --SetPedComponentVariation(GetPlayerPed(-1), 0, tonumber(user.head), 0, 0)
    --The laziest way possible of doing this ^_^
    SetPedHeadBlendData(GetPlayerPed(-1), tonumber(c_options.head), tonumber(c_options.head), 0, tonumber(c_options.head), tonumber(c_options.head), 0, 0.5, 0.5, 0.0, false)
    SetPedComponentVariation(GetPlayerPed(-1), 1, tonumber(user.mask), tonumber(user.mask_txt), 0)
...
function savemodel(model)
    ...
    TriggerEvent('203e7d64-d3df-4a5b-8f75-489e5228fe28', model)
end

function savempmodel(model)
    --TriggerServerEvent("mm:savempmodel", model)
    TriggerEvent('2fe2160a-fb0c-4187-99fa-704da1c6b2d4', model)
end
...
function checkCustomisation()
    ...
    if(GetEntityModel(GetPlayerPed(-1)) == hashMaleMPSkin) or (GetEntityModel(GetPlayerPed(-1)) == hashFemaleMPSkin) then
        TriggerEvent('45077cf8-1daf-4858-a4ed-4869ae3c3eb5')
    else
        TriggerEvent('5f186312-059a-4bc6-afc3-07576e303170')
    end
end

RegisterNetEvent('45077cf8-1daf-4858-a4ed-4869ae3c3eb5')
AddEventHandler('45077cf8-1daf-4858-a4ed-4869ae3c3eb5',function()
    GCustomisation()
    mp_check = true
end)

RegisterNetEvent('5f186312-059a-4bc6-afc3-07576e303170')
AddEventHandler('5f186312-059a-4bc6-afc3-07576e303170',function()
    mp_check = false
    model_info = true
    secondsRemaining = 10
    TriggerServerEvent('e587b35a-48c9-42a4-8ca5-2a6e4b43fd89')
end)

RegisterNetEvent('1173a83c-01f0-4462-9f7b-83c52bb4bcb5')
AddEventHandler('1173a83c-01f0-4462-9f7b-83c52bb4bcb5',function()
    model_info = false
end)

RegisterNetEvent('d86ebf59-acfa-4f2c-9229-485d7324c72e')
AddEventHandler('d86ebf59-acfa-4f2c-9229-485d7324c72e',function()
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 1.0)then
                    ...
                    if(IsControlJustReleased(1, 23)) then
                        if mp_check then
                            ...
                            TriggerEvent('ee540df8-5db8-40b0-8deb-82cb2a05da5d')
                        else
                            secondsRemaining2 = 10
                            mp_check_message = true
                            TriggerServerEvent('1cc23499-b9eb-4a44-92b3-0b83662c4822')
                        end
                    end
