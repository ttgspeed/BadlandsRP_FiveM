...
function vRP.setHunger(user_id,value)
  ...
  if data then
    ...
    TriggerClientEvent('23ad28d0-b6b3-4528-ad52-77739a3c2632',source,parseInt(data.hunger))
  end
end
...
function vRP.setThirst(user_id,value)
  ...
  if data then
    ...
    TriggerClientEvent('d4b15da8-c8ad-411d-8321-6f14d2d5c67d',source,parseInt(data.thirst))
  end
end
