...
function vRP.setMoney(user_id,value)
  ...
  if source ~= nil then
    TriggerClientEvent('37059c50-9b00-4e5c-b7f7-3d8bd8ee1e76',source, value)
  end
end
...
function vRP.setBankMoney(user_id,value)
  ...
  if tmp then
    ...
    local source = vRP.getUserSource(user_id)
    if source ~= nil then
      TriggerClientEvent('cef14c1a-ee85-4873-9437-5f062c94d38c',source, value)
    end
  end
end
...
AddEventHandler('2ebdc20f-a340-4cc8-816c-5cef2b67dcc7',function(user_id,source,name,last_login)
...
-- save money on leave
AddEventHandler('87f55cb6-f8c0-441d-9a07-dc7e493f87e0',function(user_id,source)
  -- (wallet,bank)
  local tmp = vRP.getUserTmpTable(user_id)
  if tmp then
...
AddEventHandler('a1584587-16fb-4df4-9736-273381ffa701', function()
...
AddEventHandler('bb28a4b4-e680-4f5e-9c58-9d0ef716da70',function(user_id, source, first_spawn)
  if first_spawn then
    ...
    TriggerClientEvent('37059c50-9b00-4e5c-b7f7-3d8bd8ee1e76',source, cash)
  end
end)
