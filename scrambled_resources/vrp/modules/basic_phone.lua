...
RegisterServerEvent('135b50ce-44b2-429e-a848-8153b595ee2c')
AddEventHandler('135b50ce-44b2-429e-a848-8153b595ee2c', function(x,y,z)
    ...
    vRP.getUserByPhone(phone, function(dest_id)
      if identity and dest_id then
        ...
        if dest_src then
          ...
          TriggerClientEvent('7fc89954-c170-42e8-8cf3-550d52ae0459', dest_src, "notification", 0.1)
