...
RegisterServerEvent('de2a7aff-ab77-4806-9cb0-be0131be511e')
AddEventHandler('de2a7aff-ab77-4806-9cb0-be0131be511e', function(vehicle,mods,vCol,vColExtra,eCol,eColExtra,wheeltype,plateindex,windowtint,smokecolor1,smokecolor2,smokecolor3,neoncolor1,neoncolor2,neoncolor3)
...
RegisterServerEvent('ceb1ce07-8be7-4037-a3f3-9a2b085a8e87')
AddEventHandler('ceb1ce07-8be7-4037-a3f3-9a2b085a8e87', function(garage, vehicle)
  local source = source
  local player = vRP.getUserId(source)
...
RegisterServerEvent('573b3e23-8ebb-497d-92a3-23daad45122a')
AddEventHandler('573b3e23-8ebb-497d-92a3-23daad45122a', function(garage, vehicle)
  sellVehicle(source, garage, vehicle)
  return true
end)

RegisterServerEvent('04808170-7229-4ca1-9ff1-02bbcf7252fc')
AddEventHandler('04808170-7229-4ca1-9ff1-02bbcf7252fc', function()
...
function playerGarage.getPlayerVehicles(message)
  ...
  MySQL.Async.fetchAll('SELECT * FROM vrp_user_vehicles WHERE user_id = @user_id', {user_id = user_id}, function(_pvehicles)
    ownedVehicles[user_id] = _pvehicles
    TriggerClientEvent('d31fa8a7-b3ad-42fd-b980-92cb1930bd1d',fs, _pvehicles)
  end)
end
...
RegisterServerEvent('90115818-c1ba-4a45-a693-f6484b3424db')
AddEventHandler('90115818-c1ba-4a45-a693-f6484b3424db', function(rentalFee)
  local player = source
  local user_id = vRP.getUserId(player)
  if user_id ~= nil then
...
RegisterServerEvent('492bd356-c6e7-4146-9b93-84187ea66e72')
AddEventHandler('492bd356-c6e7-4146-9b93-84187ea66e72', function(plate,vehName)
