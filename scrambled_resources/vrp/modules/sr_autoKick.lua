RegisterServerEvent('fec98dca-8900-466b-996a-7de72699eaf1')
AddEventHandler('fec98dca-8900-466b-996a-7de72699eaf1', function(clientPlayerNumber, name, id)
	...
	if(clientPlayerNumber < serverPlayerNumber) then
		if(clientPlayerNumber == 1) then -- if player are solo
			local reason = 'Auto-Kick Solo Session Detected' -- reason of kick (solo session detected)
			...
			TriggerClientEvent('chatMessage', -1, 'SERVER', { 0, 0x99, 255 },  "^2"..name .. " ^0(^4" ..id .. "^0) ^1was kicked : ^2" .. reason) -- In game chat message (example: John Doe (ID) was kicked for Auto-Kick Session solo détectée)
