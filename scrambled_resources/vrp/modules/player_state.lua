...
AddEventHandler('1defbc3c-6327-496c-951a-8449c1a25754', function(user_id, source, first_spawn)
...
AddEventHandler('f3c7c7c9-3e2a-4b37-8542-286b9a1a2317',function()
  print("player die")
...
AddEventHandler('bb28a4b4-e680-4f5e-9c58-9d0ef716da70',function(user_id,source,first_spawn)
  if first_spawn then
    ...
    TriggerClientEvent('162bcd03-2975-476a-aa2a-cddf9a80aad8', source)
  end
end)
