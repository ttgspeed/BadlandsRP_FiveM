...
RegisterNetEvent('c3639cc6-073a-4d02-8aec-d6fd1ad95e5f')
AddEventHandler('c3639cc6-073a-4d02-8aec-d6fd1ad95e5f', function()
	startGolf()
	TriggerEvent('cdc28909-b231-4b55-b44c-1fdf835aa67d',"Press E to swing, A-D to rotate, Y to swap club.")
end)

RegisterNetEvent('cfd6d581-0a92-4981-ae3a-cf163d1af92b')
AddEventHandler('cfd6d581-0a92-4981-ae3a-cf163d1af92b', function()
	startGolfHud()
end)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if distance < 1.5 then
			...
			if golfplaying then
				DisplayHelpText("Press ~g~~INPUT_DETONATE~~s~ to end golf.")
			else
				DisplayHelpText("Press ~g~~INPUT_DETONATE~~s~ to start golf ($100).")
			end
			if (IsControlJustReleased(1, 47)) then
				...
				if (golfplaying) then
					...
					--spawnCart()
					TriggerServerEvent('bdd2e3d7-6c40-4428-a26a-0396215f635f',100)
...
function startGolf()
	...
	golfplaying = true
	TriggerEvent('cfd6d581-0a92-4981-ae3a-cf163d1af92b')
	Citizen.CreateThread(function()
		while golfplaying do
			Citizen.Wait(1000)
			local playerLoc = GetEntityCoords(GetPlayerPed(-1))
...
function endgame()
	TriggerEvent('53b5e474-4ef9-4899-877e-e276e6b28a9a')
...
function endShot()
	TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfbag01")
	inTask = false
	...
	if distance < 1.5 then
		TriggerEvent('cdc28909-b231-4b55-b44c-1fdf835aa67d',"You got the ball with in range!")
		totalgolfstrokes = golfstrokes + totalgolfstrokes
		golfstrokes = 0
		ballstate = 1
	end
	if golfstrokes > 12 then
		TriggerEvent('cdc28909-b231-4b55-b44c-1fdf835aa67d',"You took too many shots..")
		totalgolfstrokes = golfstrokes + totalgolfstrokes
		golfstrokes = 0
		ballstate = 1
	end
...
function attachClub()
	...
	if golfclub == 3 then
		TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfdriver01")
		clubname = "Wood"
	elseif golfclub == 2 then
		TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfwedge01")
		clubname = "Wedge"
	elseif golfclub == 1 then
		TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfiron01")
		clubname = "1 Iron"
	elseif golfclub == 4 then
		TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfiron03")
		clubname = "3 Iron"
	elseif golfclub == 5 then
		TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfiron05")
		clubname = "5 Iron"
	elseif golfclub == 6 then
		TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfiron07")
		clubname = "7 Iron"
	else
		TriggerEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f',"golfputter01")
		clubname = "Putter"
	end
end
...
function idleShot()
	...
	while golfstate == 2 do
		...
		if (IsControlJustReleased(1, 38)) then
			...
			if not inLoop then
				TriggerEvent('f4a8a14d-d75d-43ce-b3b2-48c0b60e6984')
			end
		end
	end
...
RegisterNetEvent('f4a8a14d-d75d-43ce-b3b2-48c0b60e6984')
AddEventHandler('f4a8a14d-d75d-43ce-b3b2-48c0b60e6984', function()
	inLoop = true
	while inLoop do
		Citizen.Wait(0)
		idleLoop()
...
function ballCam()
	...
	TriggerEvent('d831097a-0dca-427a-b4a6-499e7275b368')
end

RegisterNetEvent('d831097a-0dca-427a-b4a6-499e7275b368')
AddEventHandler('d831097a-0dca-427a-b4a6-499e7275b368', function()
	local timer = 20000
	while timer > 0 do
		Citizen.Wait(5)
...
RegisterNetEvent('cdc28909-b231-4b55-b44c-1fdf835aa67d')
AddEventHandler('cdc28909-b231-4b55-b44c-1fdf835aa67d', function(response)
	TriggerEvent('chatMessage', 'GOLF: ', { 0, 11, 0 }, response)
end)

RegisterNetEvent('53b5e474-4ef9-4899-877e-e276e6b28a9a')
AddEventHandler('53b5e474-4ef9-4899-877e-e276e6b28a9a', function()
	removeAttachedProp()
end)

RegisterNetEvent('62d96235-0f40-4449-ac01-32f47a39eb1f')
AddEventHandler('62d96235-0f40-4449-ac01-32f47a39eb1f', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	removeAttachedProp()
...
RegisterNetEvent('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f')
AddEventHandler('2ef51241-ef91-4df6-9e1f-6d2223ac8d9f', function(item)
	TriggerEvent('62d96235-0f40-4449-ac01-32f47a39eb1f',attachPropList[item]["model"], attachPropList[item]["bone"], attachPropList[item]["x"], attachPropList[item]["y"], attachPropList[item]["z"], attachPropList[item]["xR"], attachPropList[item]["yR"], attachPropList[item]["zR"])
end)
