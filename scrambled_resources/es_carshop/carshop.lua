...
RegisterNUICallback('storeVehicle', function(data, cb)
	TriggerServerEvent('04808170-7229-4ca1-9ff1-02bbcf7252fc')
	EnableGui(false)
	cb('ok')
end)

RegisterNUICallback('buy_vehicle', function(veh, cb)
	TriggerServerEvent('ceb1ce07-8be7-4037-a3f3-9a2b085a8e87', veh.garage, veh.vehicle)
	EnableGui(false)
	cb('ok')
end)

RegisterNUICallback('sell_vehicle', function(veh, cb)
	TriggerServerEvent('573b3e23-8ebb-497d-92a3-23daad45122a', veh.garage, veh.vehicle)
	EnableGui(false)
	cb('ok')
end)

RegisterNetEvent('9a83990e-5a07-4b19-8eb1-27bcb18bf586')
AddEventHandler('9a83990e-5a07-4b19-8eb1-27bcb18bf586', function(v)
	SendNUIMessage({
		type = "vehicles",
		enable = v
	})
...
RegisterNetEvent('0c497191-81d6-4dca-a575-2e5ad1446319')
AddEventHandler('0c497191-81d6-4dca-a575-2e5ad1446319', function(v)
	SendNUIMessage({
		type = "vehicle",
		enable = v
	})
...
RegisterNetEvent('e6252153-ed2e-42e0-9b52-c8ae7396e2cf')
AddEventHandler('e6252153-ed2e-42e0-9b52-c8ae7396e2cf', function()
	EnableGui(false)
end)
...
RegisterNetEvent('81f59815-322f-4629-a30a-94977d202ad1')
AddEventHandler('81f59815-322f-4629-a30a-94977d202ad1', function(v, options)
...
local player_owned = {}
RegisterNetEvent('56dd05b4-1213-4d00-9291-cfcf6d80b458')
AddEventHandler('56dd05b4-1213-4d00-9291-cfcf6d80b458', function()
...
RegisterNetEvent('d31fa8a7-b3ad-42fd-b980-92cb1930bd1d')
AddEventHandler('d31fa8a7-b3ad-42fd-b980-92cb1930bd1d', function(r)
...
Citizen.CreateThread(function()
	for k,v in ipairs(carshops) do
		if v.blip then
			TriggerEvent('7e043c1e-57a4-42da-9680-8d00d692e281', 50, v.x, v.y, v.z)
		end
	end
	for k,v in ipairs(freeBikeshops) do
		if v.blip then
			TriggerEvent('7e043c1e-57a4-42da-9680-8d00d692e281', 376, v.x, v.y, v.z)
		end
	end
	for k,v in ipairs(goKartshops) do
		if v.blip then
			TriggerEvent('7e043c1e-57a4-42da-9680-8d00d692e281', 127, v.x, v.y, v.z)
		end
	end
	for k,v in ipairs(boatshops) do
		if v.blip then
			TriggerEvent('7e043c1e-57a4-42da-9680-8d00d692e281', 427, v.x, v.y, v.z)
		end
	end
	for k,v in ipairs(aircraftshops) do
		if v.blip then
	  	TriggerEvent('7e043c1e-57a4-42da-9680-8d00d692e281', 16, v.x, v.y, v.z)
		end
	end
end)

RegisterNetEvent('7e043c1e-57a4-42da-9680-8d00d692e281')
AddEventHandler('7e043c1e-57a4-42da-9680-8d00d692e281', function(type, x, y, z)
...
RegisterNetEvent('18e37505-b324-4d0c-b580-f1154712743e')
AddEventHandler('18e37505-b324-4d0c-b580-f1154712743e', function(r, g, b)
	SetVehicleCustomPrimaryColour(NetworkGetEntityFromNetworkId(spawnedVehicle),  r,  g,  b)
end)

RegisterNetEvent('587b8935-d274-41ff-a4dc-ca782636ca15')
AddEventHandler('587b8935-d274-41ff-a4dc-ca782636ca15', function(r, g, b)
		  				...
		  				if(IsControlJustReleased(1, 51))then
							license_server.getPlayerLicense_client({"driverlicense"}, function(driverlicense)
			  					if(driverlicense == 1) then
									...
									TriggerEvent('1ce2a1c6-8967-482f-8442-30132c012b8c', {text = msg , type = "alert", timeout = math.random(1000, 10000)})
			  					end
							end)
		  				end
					else
			...
			if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 100.0)then
				...
				if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
					if(not IsPedInAnyVehicle(GetPlayerPed(-1), false))then
						...
						if(IsControlJustReleased(1, 51))then
							TriggerServerEvent('90115818-c1ba-4a45-a693-f6484b3424db', 500)
						end
					else
						DisplayHelpText("You cannot be in a vehicle while accessing the garage.")
					end
