...
Citizen.CreateThread(function()
    ...
    TriggerServerEvent('4d6af728-ee7f-484f-9293-25ddaff90f59')
    Wait(5000)
    while true do
        Citizen.Wait(0)
...
RegisterNetEvent('b4519fa4-62a2-488d-9152-98720782c8a7')
AddEventHandler('b4519fa4-62a2-488d-9152-98720782c8a7',function(st)
    StationsPrice = st
end)
