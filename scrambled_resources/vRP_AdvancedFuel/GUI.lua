...
RegisterNetEvent('2c1a83d5-1c51-4269-9529-64ca587ae1aa')
AddEventHandler('2c1a83d5-1c51-4269-9529-64ca587ae1aa', function(title)
	Menu.Title(title)
end)

RegisterNetEvent('38dcc2a4-aab5-4bc8-babf-e24c81ce27c0')
AddEventHandler('38dcc2a4-aab5-4bc8-babf-e24c81ce27c0', function(option, cb)
	cb(Menu.Option(option))
end)

RegisterNetEvent('c48b75ef-6ee1-42e4-a411-ed447e28207d')
AddEventHandler('c48b75ef-6ee1-42e4-a411-ed447e28207d', function(option, bool, cb)
	Menu.Bool(option, bool, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('adb1b8be-8373-49d3-ad64-f92702e0d5fc')
AddEventHandler('adb1b8be-8373-49d3-ad64-f92702e0d5fc', function(option, int, min, max, cb)
	Menu.Int(option, int, min, max, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('743fe0da-41b5-4d10-852d-17e2dd92b169')
AddEventHandler('743fe0da-41b5-4d10-852d-17e2dd92b169', function(option, array, position, cb)
	Menu.StringArray(option, array, position, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('6324f097-f790-4c56-9bcd-679e876643a5')
AddEventHandler('6324f097-f790-4c56-9bcd-679e876643a5', function()
