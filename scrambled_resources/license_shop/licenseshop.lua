...
RegisterNUICallback('buy_license', function(lic, cb)
    TriggerServerEvent('c03d8081-2fa2-4128-8e44-68e5015ace1f', lic.license)
    EnableGui(false)
    cb('ok')
end)

RegisterNetEvent('308f62d4-3f1e-496d-84c8-908209f49808')
AddEventHandler('308f62d4-3f1e-496d-84c8-908209f49808', function(v)
	SendNUIMessage({
        type = "vehicles",
        enable = v
    })
...
RegisterNetEvent('6474f2e0-3614-409e-bd67-1769e5a29cf6')
AddEventHandler('6474f2e0-3614-409e-bd67-1769e5a29cf6', function(v)
	SendNUIMessage({
        type = "vehicle",
        enable = v
    })
...
RegisterNetEvent('7496c8c1-ca08-4636-adc2-a40e6e07edfc')
AddEventHandler('7496c8c1-ca08-4636-adc2-a40e6e07edfc', function()
	EnableGui(false)
end)
...
-- RegisterNetEvent('5d9de27b-eecb-4000-ba23-64198766abff')
-- AddEventHandler('5d9de27b-eecb-4000-ba23-64198766abff', function(r)
...
Citizen.CreateThread(function()
	for k,v in ipairs(licenseshops) do
		if v.blip then
			TriggerEvent('c2abd2c0-dc0c-442e-88f0-b5036485f0f6', 77, v.x, v.y, v.z)
		end
	end
end)

RegisterNetEvent('c2abd2c0-dc0c-442e-88f0-b5036485f0f6')
AddEventHandler('c2abd2c0-dc0c-442e-88f0-b5036485f0f6', function(type, x, y, z)
...
RegisterNetEvent('6d6e2b19-c3be-4494-9b3b-c26933e39cee')
AddEventHandler('6d6e2b19-c3be-4494-9b3b-c26933e39cee', function(r, g, b)
	SetVehicleCustomPrimaryColour(NetworkGetEntityFromNetworkId(spawnedVehicle),  r,  g,  b)
end)

RegisterNetEvent('6332c919-efbb-4931-b57e-801da2169955')
AddEventHandler('6332c919-efbb-4931-b57e-801da2169955', function(r, g, b)
