...
Citizen.CreateThread(function()
  while true do
    ...
    if IsInTaxi() and GetPedInVehicleSeat(veh, -1) ~= ped then
      local ped = GetPlayerPed(-1)
      local veh = GetVehiclePedIsIn(ped, false)
      TriggerEvent('5f86ab03-92bd-4475-89a0-1989c38e2544', veh)
      openGui()
      meterOpen = true
    end
    ...
    while true do
      ...
      if(IsInTaxi()) then
        if (inTaxi == false) then
          ...
          TriggerEvent('1ce2a1c6-8967-482f-8442-30132c012b8c', {text = msg , type = "success", layout = "centerLeft", queue = "global", theme = "gta", timeout = 5000})
        end
        inTaxi = true
        local ped = GetPlayerPed(-1)
        local veh = GetVehiclePedIsIn(ped, false)
        if(IsInTaxi() and GetPedInVehicleSeat(veh, -1) == ped) then
          if IsControlJustReleased(0, 213)  then -- HOME
            TriggerEvent('ae4dc2fc-43b9-4894-b5cf-4e403f112b5a')
            Citizen.Wait(100)
          end
          if IsControlJustReleased(0, 311)  then -- K
            TriggerEvent('c710d299-1213-462c-9d3c-ad76dee7bfd0')
            Citizen.Wait(100)
          end
          if IsControlJustReleased(0,7) then -- L
            TriggerEvent('8ccb7238-7a14-4819-bb5c-21904e4bcd27')
            Citizen.Wait(100)
          end
        end
      else
...
RegisterNetEvent('ae4dc2fc-43b9-4894-b5cf-4e403f112b5a')
AddEventHandler('ae4dc2fc-43b9-4894-b5cf-4e403f112b5a', function()
  local ped = GetPlayerPed(-1)
  local veh = GetVehiclePedIsIn(ped, false)
  if(IsInTaxi() and GetPedInVehicleSeat(veh, -1) == ped) then
    if meterOpen then
...
RegisterNetEvent('c710d299-1213-462c-9d3c-ad76dee7bfd0')
AddEventHandler('c710d299-1213-462c-9d3c-ad76dee7bfd0', function()
  local ped = GetPlayerPed(-1)
  local veh = GetVehiclePedIsIn(ped, false)
  if(IsInTaxi() and GetPedInVehicleSeat(veh, -1) == ped) then
    if meterActive then
...
RegisterNetEvent('8ccb7238-7a14-4819-bb5c-21904e4bcd27')
AddEventHandler('8ccb7238-7a14-4819-bb5c-21904e4bcd27', function()
  local ped = GetPlayerPed(-1)
  local veh = GetVehiclePedIsIn(ped, false)
  if(IsInTaxi() and GetPedInVehicleSeat(veh, -1) == ped) then
    local _fare = DecorGetFloat(veh, "fares")
...
RegisterNetEvent('5f86ab03-92bd-4475-89a0-1989c38e2544')
AddEventHandler('5f86ab03-92bd-4475-89a0-1989c38e2544', function(veh)
  local id = PlayerId()
...
RegisterNetEvent('2acc47ad-36fd-4cba-b386-4a39c7924eaf')
AddEventHandler('2acc47ad-36fd-4cba-b386-4a39c7924eaf', function(action, value)
...
if testMode then
  RegisterNetEvent('2f7c6f76-6203-4542-a98c-5bdc406d3d68')
  AddEventHandler('2f7c6f76-6203-4542-a98c-5bdc406d3d68', function(vehicleName)
