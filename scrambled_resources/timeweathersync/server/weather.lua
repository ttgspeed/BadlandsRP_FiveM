...
function updateWeatherString()
	...
	TriggerClientEvent('5447709f-ac68-4cab-8365-aed98e153be4', -1, currentWeatherData)
end

-- Sync Weather once player joins.
RegisterServerEvent('69f6b495-73cf-4523-a167-61b137022966')
AddEventHandler('69f6b495-73cf-4523-a167-61b137022966',function()
	print("Syncing weather for: "..GetPlayerName(source))
	TriggerClientEvent('5447709f-ac68-4cab-8365-aed98e153be4', source, currentWeatherData)
end)

-- Toggle if weather should auto change.
RegisterServerEvent('85ed3c07-f444-49ac-a60a-3cff0dedcbbf')
AddEventHandler('85ed3c07-f444-49ac-a60a-3cff0dedcbbf',function(from)
...
AddEventHandler('chatMessage', function(from,name,message)
	if(string.sub(message,1,1) == "/") then
		...
		if(cmd == "/toggleweather")then
			...
			TriggerEvent('85ed3c07-f444-49ac-a60a-3cff0dedcbbf', from)
		end
		...
		if(cmd == "/setweather")then
			...
			resetFlag = true
			TriggerClientEvent('5447709f-ac68-4cab-8365-aed98e153be4', -1, currentWeatherData) -- Sync weather for all players
