...
items["cocaine_pure"] = {"Pure Cocaine", "High quality cocaine made by a skilled chemist.",function(args) end,0.2}
items["cocaine_poor"] = {"Poor Quality Cocaine", "Low quality cocaine made by some junkie in a rat infested lab.",function(args) end,0.2}
