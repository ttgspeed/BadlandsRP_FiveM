...
function tvRP.notify(msg, alert)
  ...
  VrpSendNotification({text = msg , type = "success", layout = "centerLeft", queue = "left", theme = "gta", timeout = 5000})
...
function VrpSetQueueMax(queue, max)
    local tmp = {
...
function VrpSendNotification(options)
