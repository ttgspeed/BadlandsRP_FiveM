...
Citizen.CreateThread(function()
    ...
    RequestIpl("canyonriver01_lod")
		...
		SetIplPropState(GetInteriorAtCoords(2800.000, -3800.000, 100.000), "Set_Crowd_A", true, true)
		SetIplPropState(GetInteriorAtCoords(2800.000, -3800.000, 100.000), "Set_Crowd_B", true, true)
		SetIplPropState(GetInteriorAtCoords(2800.000, -3800.000, 100.000), "Set_Crowd_C", true, true)
		SetIplPropState(GetInteriorAtCoords(2800.000, -3800.000, 100.000), "Set_Crowd_D", true, true)
		SetIplPropState(GetInteriorAtCoords(2800.000, -3800.000, 100.000), "Set_Wasteland_Scene", true, true)
		SetIplPropState(GetInteriorAtCoords(2800.000, -3800.000, 100.000), "Set_Dystopian_03", true, true)
