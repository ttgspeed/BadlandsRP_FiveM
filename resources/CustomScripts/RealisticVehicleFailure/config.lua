...
cfg = {
	...
	engineDamageExponent = 2.2,					-- How much should the handling file engine damage setting be compressed toward 1.0. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	...
	cascadingFailureThreshold = 125.0,			-- Below this value, health cascading failure will set in
...
repairCfg = {
	mechanics = {
		...
		{name="Mechanic", id=446, r=25.0, x=-79.46,   y=6420.86,  z=31.49},	-- Paleto Gas Station -79.462882995605,6420.8666992188,31.490440368652
...
RepairWhitelist =
{
	...
	"ip:192.168.2.105"			-- not sure if ip whitelist works?
}
