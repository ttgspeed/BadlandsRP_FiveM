INTERIORS = {
  -- HOPITAL
  [1] = {id = 1, x = 275.46, y = -1361.22, z = 24.53, h = 50.37, name = "Enter Hospital", destination = {2}},
  [2] = {id = 2, x = 343.47, y = -1398.81, z = 32.51, h = 49.13, name = "Exit Hospital", destination = {1}},

  -- FIB
  [4] = {id = 4, x = 138.18788146973, y = -764.86633300781, z = 45.75199508667,  name = "FIB Lobby", destination = {5}},
  ...
  [9] = {id = 9, x = -1394.5030517578, y = -596.09210205078, z = 30.319562911987, h = 205.4248046875, name = "Enter Bahama Mamas", destination = {8}},

  --Sandy shore cells
  [10] = {id = 10, x = 1844.8133544922, y = 3659.712890625, z = -116.78990936279, h = 35.407787322998, name = "Enter Cells", destination = {11}},
  [11] = {id = 11, x = 1856.9282226563, y = 3689.2209472656, z = 34.267040252686, h = 205.4248046875, name = "Exit Cells", destination = {10}},
  ...
  [19] = {id = 19,x = 3526.3579101563, y = 3673.7409667969, z = 28.121139526367,  name = "Exit Exit", destination = {18}},

  -- Yankton 3557.2287597656,-4683.7763671875,114.5895767212 // -1021.4697265625,-2759.3962402344,0.80036199092864
  [20] = {id = 20, x =  3557.2287597656, y = -4683.7763671875, z = 114.5895767212,  name = "Travel to Ludendorff", destination = {21}},
  [21] = {id = 21,x = -1021.4697265625, y = -2759.3962402344, z = 0.80036199092864,  name = "Travel to Los Santos", destination = {20}},
