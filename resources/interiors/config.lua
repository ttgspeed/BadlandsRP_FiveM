INTERIORS = {
  ...
  [50] = {id = 50, x = 319.4739074707, y = -559.57989501953, z = 28.743776321411,  name = "Go to parking", destination = {51}},
	...
	[52] = {id = 52, x = 136.17930603028, y = -761.70587158204, z = 234.25194702148,  name = "", destination = {53}},
	[53] = {id = 53, x = 2625.7709960938, y = -3884.2097167968, z = 141.09983215332,  name = "Enter Arena", destination = {}},
}
