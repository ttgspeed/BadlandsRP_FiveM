...
RegisterNetEvent('CustomScript:ZoomSetup')
AddEventHandler('CustomScript:ZoomSetup', function()
  InitialSetup()
end)

RegisterNetEvent('CustomScript:ZoomTranstion')
AddEventHandler('CustomScript:ZoomTranstion', function()
