...
----Front wheel (Bikes)----
	frontwheel = {
		...
		{name = "Streetspecial Chrome", wtype = 6, mod = 14, price = 5000},
		...
		{name = "Triplethreat Chrome", wtype = 6, mod = 19, price = 5000},
		{name = "Stilleto Chrome", wtype = 6, mod = 20, price = 5000},
		{name = "Iceshield Chrome", wtype = 6, mod = 21, price = 5000},
...
----Sport wheels-----
	sportwheels = {
		...
		{name = "Dashvip", wtype = 0, mod = 18, price = 1000},
		{name = "Icekid", wtype = 0, mod = 19, price = 1000},
		{name = "Ruffeld", wtype = 0, mod = 20, price = 1000},
		{name = "Wangenmaster", wtype = 0, mod = 21, price = 1000},
		{name = "Superfive", wtype = 0, mod = 22, price = 1000},
		{name = "Endov2", wtype = 0, mod = 23, price = 1000},
		{name = "Slitsix", wtype = 0, mod = 24, price = 1000},
		{name = "Inferno Chrome", wtype = 0, mod = 25, price = 5000},
		{name = "Deepfive Chrome", wtype = 0, mod = 26, price = 5000},
		{name = "Lozspeed Chrome", wtype = 0, mod = 27, price = 5000},
		{name = "Diamondcut Chrome", wtype = 0, mod = 28, price = 5000},
		{name = "Chrono Chrome", wtype = 0, mod = 29, price = 5000},
		{name = "Feroccirr Chrome", wtype = 0, mod = 30, price = 5000},
		{name = "Fiftynine Chrome", wtype = 0, mod = 31, price = 5000},
		{name = "Mercie Chrome", wtype = 0, mod = 32, price = 5000},
		{name = "Syntheticz Chrome", wtype = 0, mod = 33, price = 5000},
		{name = "Organictyped Chrome", wtype = 0, mod = 34, price = 5000},
		{name = "Endov1 Chrome", wtype = 0, mod = 35, price = 5000},
		...
		{name = "Dashvip Chrome", wtype = 0, mod = 43, price = 5000},
		{name = "Icekid Chrome", wtype = 0, mod = 44, price = 5000},
		{name = "Ruffeld Chrome", wtype = 0, mod = 45, price = 5000},
		{name = "Wangenmaster Chrome", wtype = 0, mod = 46, price = 5000},
		{name = "Superfive Chrome", wtype = 0, mod = 47, price = 5000},
		{name = "Endov2 Chrome", wtype = 0, mod = 48, price = 5000},
		{name = "Slitsix Chrome", wtype = 0, mod = 49, price = 5000},
...
-----Suv wheels------
	suvwheels = {
		...
		{name = "Royalsix Chrome", wtype = 3, mod = 23, price = 5000},
		{name = "Fagorme Chrome", wtype = 3, mod = 24, price = 5000},
		{name = "Deluxe Chrome", wtype = 3, mod = 25, price = 5000},
		{name = "Icedout Chrome", wtype = 3, mod = 26, price = 5000},
		{name = "Cognscenti Chrome", wtype = 3, mod = 27, price = 5000},
		{name = "Lozspeedten Chrome", wtype = 3, mod = 28, price = 5000},
		{name = "Supernova Chrome", wtype = 3, mod = 29, price = 5000},
		{name = "Obeyrs Chrome", wtype = 3, mod = 30, price = 5000},
		{name = "Lozspeedballer Chrome", wtype = 3, mod = 31, price = 5000},
		{name = "Extra vaganzo Chrome", wtype = 3, mod = 32, price = 5000},
		{name = "Splitsix Chrome", wtype = 3, mod = 33, price = 5000},
		{name = "Empowered Chrome", wtype = 3, mod = 34, price = 5000},
		{name = "Sunrise Chrome", wtype = 3, mod = 35, price = 5000},
		{name = "Dashvip Chrome", wtype = 3, mod = 36, price = 5000},
...
-----Offroad wheels-----
	offroadwheels = {
		...
		{name = "Milspecsteelie Chrome", wtype = 4, mod = 19, price = 5000},
	},
-----Tuner wheels------
	tunerwheels = {
		...
		{name = "Rollas Chrome", wtype = 5, mod = 27, price = 5000},
		{name = "Driffmeister Chrome", wtype = 5, mod = 28, price = 5000},
		{name = "Slicer Chrome", wtype = 5, mod = 29, price = 5000},
		{name = "Elquatro Chrome", wtype = 5, mod = 30, price = 5000},
		...
		{name = "Stancedeg Chrome", wtype = 5, mod = 35, price = 5000},
		{name = "Countersteer Chrome", wtype = 5, mod = 36, price = 5000},
		{name = "Endov1 Chrome", wtype = 5, mod = 37, price = 5000},
		{name = "Endov2dish Chrome", wtype = 5, mod = 38, price = 5000},
		{name = "Guppez Chrome", wtype = 5, mod = 39, price = 5000},
		...
		{name = "Dishedeight Chrome", wtype = 5, mod = 43, price = 5000},
		...
		{name = "Rallymaster Chrome", wtype = 5, mod = 47, price = 5000},
	},
-----Highend wheels------
	highendwheels = {
		...
		{name = "Supagee Chrome", wtype = 7, mod = 24, price = 5000},
		{name = "Chromaticz Chrome", wtype = 7, mod = 25, price = 5000},
		{name = "Merciechlip Chrome", wtype = 7, mod = 26, price = 5000},
		{name = "Obeyrs Chrome", wtype = 7, mod = 27, price = 5000},
		{name = "Gtchrome Chrome", wtype = 7, mod = 28, price = 5000},
		{name = "Cheetahr Chrome", wtype = 7, mod = 29, price = 5000},
		{name = "Solar Chrome", wtype = 7, mod = 30, price = 5000},
		{name = "Splitten Chrome", wtype = 7, mod = 31, price = 5000},
		{name = "Dashvip Chrome", wtype = 7, mod = 32, price = 5000},
		{name = "Lozspeedten Chrome", wtype = 7, mod = 33, price = 5000},
		{name = "Carboninferno Chrome", wtype = 7, mod = 34, price = 5000},
		{name = "Carbonshadow Chrome", wtype = 7, mod = 35, price = 5000},
		{name = "Carbonz Chrome", wtype = 7, mod = 36, price = 5000},
		{name = "Carbonsolar Chrome", wtype = 7, mod = 37, price = 5000},
		{name = "Carboncheetahr Chrome", wtype = 7, mod = 38, price = 5000},
		{name = "Carbonsracer Chrome", wtype = 7, mod = 39, price = 5000},
	},
-----Lowrider wheels------
	lowriderwheels = {
		...
		{name = "Triplegolds Chrome", wtype = 2, mod = 17, price = 5000},
		{name = "Bigworm Chrome", wtype = 2, mod = 18, price = 5000},
		{name = "Sevenfives Chrome", wtype = 2, mod = 19, price = 5000},
		{name = "Splitsix Chrome", wtype = 2, mod = 20, price = 5000},
		...
		{name = "Superfin Chrome", wtype = 2, mod = 24, price = 5000},
		{name = "Classicrod Chrome", wtype = 2, mod = 25, price = 5000},
		{name = "Dollar Chrome", wtype = 2, mod = 26, price = 5000},
		{name = "Dukes Chrome", wtype = 2, mod = 27, price = 5000},
		{name = "Lowfive Chrome", wtype = 2, mod = 28, price = 5000},
...
-----Muscle wheels-----
	musclewheels = {
		...
		{name = "Oldschool", wtype = 1, mod = 13, price = 1000},
		{name = "Eljefe", wtype = 1, mod = 14, price = 1000},
		{name = "Dodman", wtype = 1, mod = 15, price = 1000},
		{name = "Sixgun", wtype = 1, mod = 16, price = 1000},
		{name = "Mercenary", wtype = 1, mod = 17, price = 1000},
		{name = "Classicfive Chrome", wtype = 1, mod = 18, price = 5000},
		{name = "Dukes Chrome", wtype = 1, mod = 19, price = 5000},
		{name = "Musclefreak Chrome", wtype = 1, mod = 20, price = 5000},
		...
		{name = "Dragspl Chrome", wtype = 1, mod = 25, price = 5000},
		{name = "Revolver Chrome", wtype = 1, mod = 26, price = 5000},
		{name = "Classicrod Chrome", wtype = 1, mod = 27, price = 5000},
		...
		{name = "Oldschool Chrome", wtype = 1, mod = 31, price = 5000},
		{name = "Eljefe Chrome", wtype = 1, mod = 32, price = 5000},
		{name = "Dodman Chrome", wtype = 1, mod = 33, price = 5000},
		{name = "Sixgun Chrome", wtype = 1, mod = 34, price = 5000},
