...
function randomVideo()
	...
	elseif n == 5 then
		return "PL_SP_WORKOUT"
	elseif n == 6 then
		return "PL_SP_INV" -- Jay Norris Assassination Mission Fail
	elseif n == 7 then
		return "PL_SP_INV_EXP" -- Jay Norris Assassination Mission Success
	elseif n == 8 then
		return "PL_LO_CNT"
	elseif n == 9 then
		return "PL_LO_WZL"
	elseif n == 10 then
		return "PL_LO_RS"
	elseif n == 11 then
		return "PL_LO_RS_CUTSCENE"
	elseif n == 12 then
		return "PL_SP_PLSH1_INTRO"
	elseif n == 13 then
		return "PL_LES1_FAME_OR_SHAME"
	elseif n == 14 then
		return "PL_STD_WZL_FOS_EP2"
	end
end
