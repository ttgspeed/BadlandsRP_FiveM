...
Config.PlayerLimit = 24 -- PLAYERCAP                -- How many playerslots your server has

Config.PlaceInQueueAt = 22             --[[ This determines when it will start placing players in the queue. For example, if the server has 5 people ingame, and this is set to 5, it will start placing players in queue.
