...
AddEventHandler('chatMessage', function(source, name, message, rp_name, user_id)
    if(string.sub(message,1,1) == "/") then
        ...
        if (cmd == "/ooc" or cmd == "/g") and (msg ~= nil and msg ~= "") then
            TriggerClientEvent('chatMessage', -1, "^1[^0OOC", {100, 100, 100}, "^4 " .. rp_name.. " ^4(^0"..user_id.."^4): ^0" .. msg[1] .. "^1]")
            sendToDiscord(name.." ("..rp_name.." - "..user_id..")", "**OOC**: "..msg[1])
        elseif cmd == "/tweet" and (msg ~= nil and msg ~= "") then
            TriggerClientEvent('chatMessage', -1, "^5Twitter", {100, 100, 100}, "^4 @" ..rp_name.. " ^4(^0"..user_id.."^4): ^0" .. msg[1])
            sendToDiscord(name.." ("..rp_name.." - "..user_id..")", "**TWEET**: "..msg[1])
