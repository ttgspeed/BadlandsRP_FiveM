...
AddEventHandler('chatMessage', function(source, name, message, rp_name, user_id)
    if user_id ~= nil then
        ...
        if(string.sub(message,1,1) == "/") then
            ...
            elseif cmd == "/glasses" or cmd == "/headgear" or cmd == "/cam" or cmd == "/mic" or cmd == "/bmic" or cmd == "/atm" or cmd == "/helmet" or cmd == "/carlivery" or cmd == "/carmod" or cmd == "/cardoor" or cmd == "/muteooc" or cmd == "/mutetwitter" or cmd == "/taxifare" or cmd == "/walk" or cmd == "/setweather" or cmd == "/em" or cmd == "/emote" then
            else
