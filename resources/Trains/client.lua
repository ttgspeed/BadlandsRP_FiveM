...
TicketPrice				= 0	-- Change to any value YOU think is suitable for a Metro Ticket in your (RP) Server
...
local TicketMachines = {'prop_train_ticket_02'}
...
Citizen.CreateThread(function()
	...
	function StartTrain()
		...
		if UseTwoMetros == 1 then
			...
			local blip2 = AddBlipForEntity(MetroTrain2)
			SetBlipSprite(blip2, 78)
...
RegisterNetEvent("StartTrainCMD")
AddEventHandler("StartTrainCMD", function()
	StartTrain()
end)
