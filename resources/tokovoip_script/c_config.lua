TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSServer = "ts.blrp.us", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "S1: Waiting For Support", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "http://badlandsrp.com", -- Download link displayed on blocking screen
