...
SecurityCamConfig.Locations = {
    ...
    -- },
		{
        camBox = {label = "Cocaine Lab", x = 997.36108398438, y = -3195.6650390625, z = -37.39352798462},
        cameras = {
            {label = "Camera 1", x = 998.22552490234, y = -3193.7934570312, z = -34.878173828125, r = {x = -29.908912658692, y = -1.7075471987482, z = -137.52221679688}, canRotate = false},
            {label = "Camera 2", x = 1009.193786621, y = -3201.4699707032, z = -35.067943572998, r = {x = -29.955417633056, y = 0.0, z = -6.8271822929382}, canRotate = true},
            {label = "Camera 3", x = 1017.3354492188, y = -3193.7822265625, z = -35.092945098876, r = {x = -23.420419692994, y = 0.0, z = 129.31809997558}, canRotate = false},
        },
        allowedModels = {}
    },
}
